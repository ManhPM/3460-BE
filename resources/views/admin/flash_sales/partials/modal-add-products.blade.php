    ...
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <x-input id="inputSearchProduct" name="search_product" :placeholder="__('Nhập tên sản phẩm')" />
                <div id="showSearchResultProduct" class="list-group list-group-flush mt-2 overflow-auto border rounded"
