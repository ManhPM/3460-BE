<div class="col-12 col-md-3">
    <div class="card mb-3">
        ...
        <div class="card-body d-flex justify-content-between p-2">
            ...
            <x-button.modal-delete data-route="{{ route('admin.voucher.delete', $instance->id) }}" :title="__('delete')" />
        </div>
    </div>
    <div class="card mb-3">
        <div class="card-header">
        ...
        <div class="card-body p-2">
            ...
            <x-input-switch name="is_used" value="1" :label="__('Voucher đã được sử dụng?')" :checked="$instance->is_used == 1" />
        </div>
    </div>
    <div class="card mb-3">
        <div class="card-header">
