...
@section('content')
    <div class="page-body">
        <div class="container-xl">
            <x-form :action="route('admin.membership_level.update')" type="put" :validate="true">
                <x-input type="hidden" name="id" :value="$instance->id" />
                <div class="row justify-content-center">
                    @include('admin.membership_levels.forms.edit-left')
                    @include('admin.membership_levels.forms.edit-right')
                </div>
            </x-form>
        </div>
    </div>
