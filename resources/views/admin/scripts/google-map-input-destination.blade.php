    ...
    <script>
        ...
        function getDestinationLocation() {
            if (navigator.geolocation) {
                ...
                showToastify('error', 'Lỗi', 'Trình duyệt không hỗ trợ lấy vị trí.');
                $("#getCurrentDestinationLocation .spinner-border").hide();
            }
        ...
        function initDestinationMap() {
            ...
            destinationAutocomplete = new google.maps.places.Autocomplete(document.getElementById('destinationPlace'),
                options);

            destinationAutocomplete.addListener('place_changed', function() {
                var place = destinationAutocomplete.getPlace();
                if (!place.geometry) {
                    showToastify('error', 'Lỗi', 'Không tìm thấy địa điểm: ' + place.name);
                    return;
                }
