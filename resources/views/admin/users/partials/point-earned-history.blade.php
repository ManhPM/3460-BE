@if($orders->count() > 0)
        ...
        <table class="table table-bordered table-hover">
            <thead>
                <tr>
                    ...
                    <th>{{ __('Điểm tích lũy') }}</th>
                    <th>{{ __('Tổng tiền') }}</th>
                    <th>{{ __('Ngày tích điểm') }}</th>
                    <th>{{ __('Trạng thái') }}</th>
                </tr>
            </thead>
            <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <span class="badge bg-success">
                                +{{ number_format($order->points_earned) }} {{ __('điểm') }}
                            </span>
                        </td>
    ...
    @if($orders->hasPages())
        <div class="d-flex justify-content-between align-items-center mt-3">
            ...
            <nav>
                <ul class="pagination pagination-sm mb-0" id="pointEarnedPagination">
