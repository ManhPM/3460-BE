...
abstract class BaseDataTable extends DataTable
{
     ...
     * @var array
     */
    protected array $actions = ['pageLength', 'reset', 'reload'];
    /**
    ...
    {
        // Configure buttons with language support
        $buttons = [];
        foreach ($this->actions as $action) {
            if ($action === 'pageLength') {
                $buttons[] = [
                    'extend' => 'pageLength',
                    'text' => 'Chọn số lượng hiển thị',
                ];
            } else {
                $buttons[] = $action;
            }
        ...
        $this->parameters['buttons'] = $buttons;
