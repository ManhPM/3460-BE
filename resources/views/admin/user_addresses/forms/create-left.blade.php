<div class="col-12 col-md-9">
    <div class="card mb-3">
        ...
        <div class="row card-body">
            <x-input name="user_id" type="hidden" :value="$userId" />
            <div class="col-md-6">
                <div class="mb-3">
            ...
            <div class="col-md-6">
                <div class="mb-3">
                    ...
                    <x-input name="email" type="email" :value="old('email')" placeholder="{{ __('Email') }}" />
                </div>
            </div>
            <div class="mb-3 col-md-6">
                <x-label for="address" text="{{ __('Địa chỉ') }}" icon="ti ti-map-pin" required="true" />
                <x-input name="address" :value="old('address')" placeholder="{{ __('Địa chỉ') }}" :required="true" />
            </div>
            <div class="col-md-6 mb-3">
                <x-label for="name" text="{{ __('Tên địa điểm nhận') }}" icon="ti ti-user" required="true" />
                <x-input name="name" :value="old('name')" placeholder="{{ __('Tên địa điểm nhận') }}" />
            </div>
            <div class="col-md-6 mb-3">
                <x-label for="fullname" text="{{ __('Tên người nhận') }}" icon="ti ti-user" required="true" />
                <x-input name="fullname" :value="old('fullname')" placeholder="{{ __('Tên người nhận') }}" />
            </div>
            <div class="col-md-6 mb-3">
